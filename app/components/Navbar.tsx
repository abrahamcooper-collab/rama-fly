...
const servicesWithSubs = [
  ...
  },
  {
    ...
    subServices: [
      { label: "Gut Renovations", href: "/services/full-interior-renovation/gut-renovation" },
      { label: "Whole-Home Remodeling", href: "/services/full-interior-renovation/whole-home" },
      { label: "Layout Redesign & Wall Removal", href: "/services/full-interior-renovation/layout-redesign" },
      { label: "Pre-War Apartment Restoration", href: "/services/full-interior-renovation/pre-war-restoration" },
      { label: "Combining Apartments", href: "/services/full-interior-renovation/apartment-combination" },
      { label: "Space Planning & Design", href: "/services/full-interior-renovation/space-planning" },
      { label: "Permit & Project Coordination", href: "/services/full-interior-renovation/permit-coordination" },
      { label: "Turnkey Interior Build-Outs", href: "/services/full-interior-renovation/turnkey-buildouts" },
    ],
  },
  {
  ...
  },
  {
    ...
    subServices: [
      { label: "Hardwood Flooring Installation", href: "/services/flooring/hardwood" },
      { label: "Engineered Wood Flooring", href: "/services/flooring/engineered-wood" },
      { label: "Luxury Vinyl Plank (LVP)", href: "/services/flooring/luxury-vinyl-plank" },
      { label: "Tile & Porcelain Flooring", href: "/services/flooring/tile-flooring" },
      { label: "Floor Refinishing & Restoration", href: "/services/flooring/refinishing" },
      { label: "Subfloor Repair & Leveling", href: "/services/flooring/subfloor-repair" },
      { label: "Baseboard & Trim Integration", href: "/services/flooring/baseboard-trim" },
      { label: "Radiant Heated Floors", href: "/services/flooring/heated-floors" },
    ],
  },
  {
  ...
  },
  {
    ...
    subServices: [
      { label: "Licensed Electrician Coordination", href: "/services/electrical-plumbing-coordination/electrical" },
      { label: "Plumbing Rough-In & Fixtures", href: "/services/electrical-plumbing-coordination/plumbing" },
      { label: "Panel & Wiring Upgrades", href: "/services/electrical-plumbing-coordination/wiring-upgrades" },
      { label: "Recessed & Accent Lighting", href: "/services/electrical-plumbing-coordination/lighting" },
      { label: "Kitchen & Bath Plumbing", href: "/services/electrical-plumbing-coordination/kitchen-bath-plumbing" },
      { label: "Permit & Inspection Management", href: "/services/electrical-plumbing-coordination/permits" },
      { label: "Code Compliance Upgrades", href: "/services/electrical-plumbing-coordination/code-compliance" },
      { label: "Smart Home Pre-Wiring", href: "/services/electrical-plumbing-coordination/smart-home" },
    ],
  },
];
